...
const providers=[
  ...
  {name:"Gemini",key:process.env.GEMINI_API_KEY,authUrl:`${process.env.GEMINI_BASE_URL??"https://generativelanguage.googleapis.com/v1beta/openai"}/models`,headers:()=>({authorization:`Bearer ${process.env.GEMINI_API_KEY}`}),live:()=>compatibleLive(process.env.GEMINI_BASE_URL??"https://generativelanguage.googleapis.com/v1beta/openai",process.env.GEMINI_API_KEY,process.env.GEMINI_FAST_MODEL??"gemini-3.5-flash-lite")},
