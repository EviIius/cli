...
export type JobRecord={id:string;tenantId:string;actorId?:string;type:"single"|"planner-reviewer"|"adhoc"|"graph";status:JobStatus;input:Record<string,unknown>;state:Record<string,unknown>;result?:unknown;error?:string;createdAt:string;updatedAt:string};
